      ...
      <Enter>
        ...
        <div className="flex w-full max-w-[62rem] flex-col items-center text-center">
          ...
          {/*
            ...
            */}
          <ul className="mt-10 grid w-full gap-x-10 gap-y-8 text-left md:mt-12 md:grid-cols-3 short:mt-7">
              ...
              <li key={quote.name} className="border-t" style={{ borderColor: "var(--accent)" }}>
                <Enter delay={DURATION.stagger * i}>
                  <figure className="pt-4">
                    <blockquote>
                      <p className="font-[family-name:var(--font-display)] text-[1.05rem] leading-[1.45] font-light text-[color:var(--bg)] md:text-[1.12rem]">
                        {quote.quote}
                      </p>
                    </blockquote>
                    <figcaption className="mt-3">
                      <p className="flex flex-wrap items-center gap-x-3 gap-y-1 font-[family-name:var(--font-label)] text-[0.62rem] tracking-[0.22em] text-[color:var(--bg)] uppercase">
