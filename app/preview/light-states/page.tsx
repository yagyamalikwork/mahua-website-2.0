    ...
    <SmoothScroll>
      ...
      <main>
        {LIGHT_STATES.map((state, i) => {
          // The first panel is the page's title; the rest are subheadings — one
          // <h1> per page, not one per panel (spec accessibility pass, Task 12).
          ...
          return (
            ...
            >
              <Reveal>
                ...
                <HeadingTag className="mt-6 max-w-[16ch] font-[family-name:var(--font-display)] text-[clamp(2.5rem,8vw,6rem)] font-light leading-[1.05]">
