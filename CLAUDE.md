...
8. **Every screen must carry weight.** No section may render more than **45%** empty space at 1440×900. If
   ...
   **`field-days` is 26.4% mean / 41.0% worst since 17 Aug 2026 and PASSES**, against 43.9% / 57.9% for the
   three bands it replaced. Three figures from that work generalise beyond this chapter. **The lever was the
   photographs, not the CSS** — on 16 Aug the chapter could not reach 45% at any card size, because four
   frames were 1163px 2.289:1 crops drawn at 1.288× the card's width; the client's 1344 × 685 re-exports
   moved the ceiling from a 903px card to 1217px and the same sweep then read 41.0%. **`cardMaxPx` was 560
