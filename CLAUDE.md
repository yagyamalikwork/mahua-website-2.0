...
> 0. [`docs/DECISIONS.md`](docs/DECISIONS.md) — **every client ruling, the forty-six-instance defect
...
| **Tests** | **419**, all green. `npm test` must stay green before any commit claiming completion. |
