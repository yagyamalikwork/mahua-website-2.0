...
> 0. [`docs/DECISIONS.md`](docs/DECISIONS.md) — **every client ruling, the thirty-nine-instance defect
...
| **Tests** | **398**, all green. `npm test` must stay green before any commit claiming completion. |
