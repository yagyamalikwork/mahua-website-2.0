...
node scripts/check_entrances.mjs                 # did each entrance stage and settle, and did EVERY parallax move — plus, since 20 Aug 2026, that the HERO's headline reveal both played and finished (it asserted the opposite until then, and passed while the client's effect was simply absent there — DECISIONS.md §21.9)
